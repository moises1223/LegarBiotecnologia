export const products = [
        ...
        specifications: [
            {
                ...
                name: "Prolina em alta concentração"
            },
            {
    ...
    
    {
        ...
        specifications: [
            {
                icon: "img/product-section/Cristais.png",
                name: "Fertilizante foliar composto + aminoácidos livres, em alta concentração"
            },
            {
                icon: "img/product-section/Fertilidade.png", 
            ...
            {
                icon: "img/product-section/Resistencia.png", 
                name: "Formulação equilibrada, para preservar e ampliar o potencial produtivo das plantas."
            },
        ...
        moreSpecs:[
            {
                title:"⦁ Recuperação rápida após um período de estresse hídrico ",
                content:" O estresse leva ao acúmulo de radicais livres, que causam danos às células vegetais (estresse oxidativo). Aminoácidos, como a glutamina e a prolina, ajudam a regular o equilíbrio redox dentro das células vegetais, promovendo a ação de antioxidantes e protegendo as plantas contra os danos oxidativos."
            },
            {
                title:"⦁ Aumenta a velocidade de absorção e translocação de nutrientes",
                content:"Quando a planta tem acesso rápido a aminoácidos, ela pode sintetizar proteínas de maneira mais eficiente, acelerando seu metabolismo geral e promovendo o crescimento celular."
            },
            {
                title:"⦁ Potencializar a produtividade da cultura",
                content:"O estimulo da síntese de proteínas, o aumento da Taxa de Fotossíntese, melhoria do metabolismo de Nitrogênio, aumento da Resiliência ao Estresse e melhoria na eficiência da absorção de nutrientes tendem a tornar a planta mais produtiva, quando comparada a plantas sem aplicação. "
            },
            {
                title:"⦁ Auxílio no metabolismo da planta",
                content:"A principal função dos aminoácidos é ser os blocos construtores das proteínas, essenciais para o crescimento e o desenvolvimento da planta. O nitrogênio, presente nos aminoácidos, é um nutriente crucial para a síntese de proteínas e outras biomoléculas."
            },
            {
                title:"⦁ Reduz a fitotoxidez dos defensivos agrícolas.",
                content:"A aplicação de aminoácidos ajuda a estimular a síntese de proteínas, acelerando a recuperação celular e a renovação dos sistemas metabólicos danificados."
            },
            {
                title:"⦁ Plantas mais adaptadas a altas temperaturas e condições limitantes",
                content:"Durante o estresse, as plantas de soja enfrentam dificuldades na manutenção do equilíbrio hídrico. Certos aminoácidos, como a prolina e a Prolina, Glicina Betaína atuam como osmólitos, ajudando na retenção de água nas células e permitindo que a planta sobreviva e se recupere mais rapidamente após períodos de seca ou salinidade."
            },
        ],
        Uses:[
            {
